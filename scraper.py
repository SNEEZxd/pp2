    ...
    def get_reviews(self): 
        ...
        while True:
            ...
            for review in soup.find_all('div',{'class':'row no-margin--bottom js_review review-box-item js_product-review user-box-container'}):
                ...
                review_data = {"user":user,"review_date":review_date,"review_score":review_score,"review_text":review_text,"vote_up_count":vote_up_count,"vote_down_count":vote_down_count,"purchase_date":purchase_date,"advantages_count":advantages_count,"disadvantages_count":disadvantages_count,"is_recommend":is_recommend}
                self.product_reviews.append_to_reviews(review_data)
                
            page_id += 1
            
        self.product_reviews.product_data_to_json(self.product_name, self.product_image, reviews_count)
        self.product_reviews.save_to_json()
        
    
        
x = CeneoScraper('94823130')
x.get_product_data()
x.get_reviews()
